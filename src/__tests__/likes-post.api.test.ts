...
describe('/posts', () => {
    ...
    let inputModelUser1 = {
        login: 'login-1',
        password: "password-1",
        email: "dimakurgan123789@gmail.com",
    }
    let inputModelUser2 = {
        login: 'login-2',
        password: "password-2",
        email: "dimakurgan123987@gmail.com",
    }
    let inputModelUser3 = {
        login: 'login-3',
        password: "password-3",
        email: "dimakurgan123789987@gmail.com",
    }
    let inputModelUser4 = {
        login: 'login-4',
        password: "password-4",
        email: "dimakurgan123789444@gmail.com",
    }
    let correctInputModelAuth = {
        loginOrEmail: 'dimakurgan123789@gmail.com',
        password: "password-1",
    }
